...
const Hero = () => {
  return (
    <div className="h-56 sm:h-64 xl:h-80 2xl:h-96  box-border">
      ...
      <div className="grid grid-flow-row-dense grid-cols-3 h-screen">
        <h1 className="col-span-1 m-auto"> ┗( ＾0＾)┓ Find inspiration</h1>
        <div className="m-auto col-span-2">
          <img
            className=" scale-150 object-cover h-auto max-w-lg transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
      ...
      <div className="grid grid-flow-row-dense grid-cols-3 h-screen ">
        <div className="m-auto col-span-2">
          <img
            className=" object-cover h-auto max-w-lg transition-all duration-300 rounded-lg blur-sm hover:blur-none"
            src="https://images.pexels.com/photos/416471/pexels-photo-416471.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          />{" "}
        </div>
        <h1 className="col-span-1 m-auto">Discover new things (◕ᴗ◕✿)</h1>
      </div>
